...
export default function Fidelite() {
  const [points] = useState(5) // Exemple : 5 points accumulés
  ...
  const rewards = [
    {
      ...
      icon: HardDrive,
      progress: points >= maxPoints ? 100 : (points / maxPoints) * 100
    },
    {
      level: 2,
      cards: 2,
      ...
      icon: HardDrive,
      progress: points >= maxPoints * 2 ? 100 : (points / (maxPoints * 2)) * 100
    },
    {
      level: 3,
      cards: 3,
      ...
      icon: HardDrive,
      progress: points >= maxPoints * 3 ? 100 : (points / (maxPoints * 3)) * 100
    }
  ]
